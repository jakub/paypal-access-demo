 ...
 * @package OpenID
 */
class Auth_OpenID_Store_DumbStore implements  Auth_OpenID_Store_OpenIDStore {

    /**
     * Creates a new {@link Auth_OpenID_Store_DumbStore} instance. For the security
     ...
     * difficult to guess.
     *
     * Each {@link Auth_OpenID_Store_DumbStore} instance that is created for use by
     * your consumer site needs to use the same $secret_phrase.
     *
     * @param string secret_phrase The phrase used to create the auth
     * key returned by getAuthKey
     */
    function Auth_OpenID_Store_DumbStore($secret_phrase)
    {
